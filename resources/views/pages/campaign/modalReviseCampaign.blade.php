<div class="modal fade" id="ModalReviseCampaign" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <!--begin::Modal content-->
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="#" id="form_revise_campaign" enctype="multipart/form-data">
                @csrf
                <!--begin::Modal header-->
                <div class="modal-header" id="kt_modal_update_customer_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">Beri Catatan</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_customer_scroll"
                        ...
                        <div id="kt_modal_update_customer_user_info" class="collapse show">
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label for="notes" class="required fw-bold fs-6 mb-2">Catatan</label>
                                <!--d::Label-->
                                <!--begin::Input-->
                ...
                <div class="modal-footer flex-center">
                    ...
                    <button id="tombol_revise_campaign"
                        onclick="save_form_modal('#tombol_revise_campaign','#form_revise_campaign','{{ route('campaign.revise', $data['id']) }}','#ModalReviseCampaign','PUT');"
