        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container">
                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="d-flex">
                                    <a href="#" class="btn btn-light btn-sm" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_users_search">Cari</a>
                                </div>
                                <!--end::Actions-->
                            </div>
                        </div>
                    ...
                    <div class="d-flex flex-wrap my-1">
                        ...
                        <div class="m-0">
                            ...
                            <select name="status" data-control="select2" data-hide-search="true"
                                ...
                                <option value="Declined">Belum Aktif</option>
                            </select>
                            <!--end::Select-->
                        </div>
                        <!--end::Select wrapper-->
                ...
                <div class="row g-6 g-xl-9">
                    ...
                    <div class="col-md-6 col-xl-4">
                        ...
                        <a href="pages/projects/project.html"
                            ...
                            <div class="card-body p-9">
                                <!--begin::Name-->
                                <div class="fs-3 fw-bolder text-dark">Bencana Alam Tarutung</div>
                                <!--end::Name-->
                                <!--begin::Description-->
                                <p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">Bantuan dana untuk korban bencana
                                </p>
                                <!--end::Description-->
                                <!--begin::Info-->
                                <div class="d-flex flex-wrap mb-5">
                                    ...
                                    <div
                                        ...
                                        <div class="fs-6 text-gray-800 fw-bolder">Rp 284.900</div>
                ...
                <div class="d-flex flex-stack flex-wrap pt-10">
                    <div class="fs-6 fw-bold text-gray-700">Menampilkan 6 dari 18 data</div>
                    <!--begin::Pages-->
                    <ul class="pagination">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-5">
                                                            <a href="#"
                                                                ...
                                                                Mitcham</a>
                                                            <div class="fw-bold text-muted">f.mitcham@kpmg.com.au
                                                            </div>
                                                        </div>
                                                        <!--end::Details-->
                                                    </div>
